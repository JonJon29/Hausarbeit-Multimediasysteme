...
In dem Video, in dem mit einem Stift auf den Tisch geklopft wurde, gab es eine wichtige Besonderheit.
Zwar wiederholt sich das Geräusch hier ständig und hört sich immer gleich an, aber der Rhythmus ist unregelmäßig.
Der zeitliche Abstand zwischen den einzelnen Berührungen variiert nämlich die ganze Zeit.
Da man sich an keinen festen Takt gewöhnen kann, muss man bei jedem Schlag genau hinschauen.
Das macht die Bewertung der Synchronität hier etwas anders als bei gleichmäßigen Bewegungen, weil man den Ton nicht so leicht vorausahnen kann.

\section{Sprache}

In dem Video der Sprache wurde eine Person gezeigt, die in einem Podcast gesprochen hat.Die Probanden haben sich nach und nach die Videoclips angeschaut.
Die Delays waren alle unterschiedlich.In den Videos mit einem Delay zwischen 50-150ms, hatten die meisten Probanden es schwer.
Die Probanden konnten es sehr schwer unterscheiden ob es synchron oder asynchron ist, sie mussten sich das Video mehrfach anschauen um eine klare Aussage zu treffen.
Ab einem Delay von 200ms konnten die Probanden die Asynchronität sehr schnell feststellen.
Die meisten Probanden hatten ab diesen Delay keine Probleme.
Interessant ist, Negative Delays werden sehr schnell wahrgenommen, positive Delays sind auch gut erkennbar, jedoch fanden es einige Probanden nicht weniger störend.
